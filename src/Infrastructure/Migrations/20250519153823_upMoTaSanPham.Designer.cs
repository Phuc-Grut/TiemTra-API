...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250519153823_upMoTaSanPham")]
    partial class upMoTaSanPham
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2703),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2705),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2707),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2707),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2709),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 5, 19, 15, 38, 21, 884, DateTimeKind.Utc).AddTicks(2709),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
