...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250518153608_upProductStatus")]
    partial class upProductStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4410),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4412),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4413),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4414),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4415),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 5, 18, 15, 36, 6, 367, DateTimeKind.Utc).AddTicks(4415),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
