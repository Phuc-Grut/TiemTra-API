...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250715100502_UpStatusProduct")]
    partial class UpStatusProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1601),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1638),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1641),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1642),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1643),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 7, 15, 17, 5, 1, 637, DateTimeKind.Unspecified).AddTicks(1644),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
