...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250425080433_updb3")]
    partial class updb3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2235),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2239),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2242),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2242),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2244),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 4, 25, 8, 4, 31, 308, DateTimeKind.Utc).AddTicks(2244),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
