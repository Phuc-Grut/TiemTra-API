...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250923085324_upvoucherStatus")]
    partial class upvoucherStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Data.Entities.OrderVoucher", b =>
                {
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5539),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5577),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5580),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5580),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5582),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 53, 23, 203, DateTimeKind.Unspecified).AddTicks(5583),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Data.Entities.Voucher", b =>
                {
                    b.Property<Guid>("VoucherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Data.Entities.OrderVoucher", b =>
                {
                    ...
                    b.HasOne("Domain.Data.Entities.Voucher", "Voucher")
                        .WithMany("OrderVouchers")
            ...
            modelBuilder.Entity("Domain.Data.Entities.Voucher", b =>
                {
                    b.HasOne("Domain.Data.Entities.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Data.Entities.User", "Updater")
                        .WithMany()
