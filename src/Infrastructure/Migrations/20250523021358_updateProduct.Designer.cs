...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250523021358_updateProduct")]
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1117),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1121),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1124),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1124),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1125),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 5, 23, 2, 13, 56, 456, DateTimeKind.Utc).AddTicks(1126),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
