...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250709093831_up_table_order_customer_user")]
    partial class up_table_order_customer_user
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7567),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7572),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7577),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7577),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7579),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 7, 9, 9, 38, 29, 432, DateTimeKind.Utc).AddTicks(7579),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
