...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250713153453_upComfirmAt")]
    partial class upComfirmAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3831),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3874),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3879),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3880),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3882),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 7, 13, 22, 34, 50, 928, DateTimeKind.Unspecified).AddTicks(3883),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
