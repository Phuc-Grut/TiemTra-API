...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250912065209_upVoucher")]
    partial class upVoucher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5231),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5277),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5282),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5283),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5286),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 9, 12, 13, 52, 6, 829, DateTimeKind.Unspecified).AddTicks(5287),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
