...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250712091607_updateOrder")]
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(380),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(384),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(388),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(389),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(390),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 7, 12, 9, 16, 5, 568, DateTimeKind.Utc).AddTicks(390),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
