...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250507091516_upProductImage")]
    partial class upProductImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1907),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1910),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1913),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1913),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1914),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 5, 7, 9, 15, 14, 180, DateTimeKind.Utc).AddTicks(1914),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
