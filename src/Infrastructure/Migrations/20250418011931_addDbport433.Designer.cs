...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250418011931_addDbport433")]
    partial class addDbport433
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8677),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8683),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8688),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8688),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8691),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 4, 18, 1, 19, 27, 796, DateTimeKind.Utc).AddTicks(8691),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
