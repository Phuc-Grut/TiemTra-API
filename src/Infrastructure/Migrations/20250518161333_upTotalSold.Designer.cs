...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250518161333_upTotalSold")]
    partial class upTotalSold
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3605),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3608),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3610),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3610),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3611),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 5, 18, 16, 13, 32, 577, DateTimeKind.Utc).AddTicks(3612),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
