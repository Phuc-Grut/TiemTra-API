...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250923083240_upTableVoucher")]
    partial class upTableVoucher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(985),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(1021),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(1024),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(1025),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(1026),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 9, 23, 15, 32, 37, 552, DateTimeKind.Unspecified).AddTicks(1027),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
