...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250425145424_upTiemTraDb")]
    partial class upTiemTraDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7166),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7169),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7172),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7172),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7174),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 4, 25, 14, 54, 21, 525, DateTimeKind.Utc).AddTicks(7174),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
