...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250706153223_up_table_customer_order")]
    partial class up_table_customer_order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2831),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2834),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2836),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2837),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2838),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 32, 21, 30, DateTimeKind.Utc).AddTicks(2838),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
