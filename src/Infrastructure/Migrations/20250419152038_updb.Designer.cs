            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1803),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1805),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1815),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1815),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1817),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 4, 19, 15, 20, 36, 107, DateTimeKind.Utc).AddTicks(1817),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
