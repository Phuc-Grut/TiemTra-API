...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250919074008_upTableOrder")]
    partial class upTableOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6779),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6812),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6815),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Staff",
                            UpdatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6815),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6817),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            RoleName = "Customer",
                            UpdatedAt = new DateTime(2025, 9, 19, 14, 40, 5, 499, DateTimeKind.Unspecified).AddTicks(6818),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
